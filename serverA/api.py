...
# Add another endpoint for AI insights
    ...
    def get_user_ai_insights():
        ...
        try:
            ...
            Based **only** on the data provided above, generate a specified and focused genuine report search web for links/sources to get better info 
            with the following sections using Markdown formatting:
